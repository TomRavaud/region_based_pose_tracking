...
void RegionModalityBase::set_color_camera_ptr(
    const std::shared_ptr<ColorCamera> &color_camera_ptr) {
  color_camera_ptr_ = color_camera_ptr;
  set_up_ = false;
}

void RegionModalityBase::set_region_model_ptr(
    const std::shared_ptr<RegionModel> &region_model_ptr) {
  region_model_ptr_ = region_model_ptr;
  set_up_ = false;
}

void RegionModalityBase::set_n_lines_max(int n_lines_max) {
  n_lines_max_ = n_lines_max;
}

void RegionModalityBase::set_use_adaptive_coverage(bool use_adaptive_coverage) {
  use_adaptive_coverage_ = use_adaptive_coverage;
}

void RegionModalityBase::set_reference_contour_length(
    float reference_contour_length) {
  reference_contour_length_ = reference_contour_length;
}

void RegionModalityBase::set_min_continuous_distance(
    float min_continuous_distance) {
  min_continuous_distance_ = min_continuous_distance;
}

void RegionModalityBase::set_function_length(int function_length) {
  function_length_ = function_length;
  set_up_ = false;
}

void RegionModalityBase::set_distribution_length(int distribution_length) {
  distribution_length_ = distribution_length;
  set_up_ = false;
}

void RegionModalityBase::set_function_amplitude(float function_amplitude) {
  function_amplitude_ = function_amplitude;
  set_up_ = false;
}

void RegionModalityBase::set_function_slope(float function_slope) {
  function_slope_ = function_slope;
  set_up_ = false;
}

void RegionModalityBase::set_learning_rate(float learning_rate) {
  learning_rate_ = learning_rate;
}

void RegionModalityBase::set_n_global_iterations(int n_global_iterations) {
  n_global_iterations_ = n_global_iterations;
}

void RegionModalityBase::set_scales(const std::vector<int> &scales) {
  scales_ = scales;
}

void RegionModalityBase::set_standard_deviations(
    const std::vector<float> &standard_deviations) {
  standard_deviations_ = standard_deviations;
}

void RegionModalityBase::UseSharedColorHistograms(
...
void RegionModalityBase::DoNotUseSharedColorHistograms() {
  color_histograms_ptr_ = nullptr;
  use_shared_color_histograms_ = false;
  set_up_ = false;
}

bool RegionModalityBase::set_n_histogram_bins(int n_histogram_bins) {
  if (use_shared_color_histograms_) {
...
bool RegionModalityBase::set_learning_rate_f(float learning_rate_f) {
  if (use_shared_color_histograms_) {
...
bool RegionModalityBase::set_learning_rate_b(float learning_rate_b) {
  if (use_shared_color_histograms_) {
...
void RegionModalityBase::DoNotUseRegionChecking() {
  silhouette_renderer_ptr_ = nullptr;
  use_region_checking_ = false;
  set_up_ = false;
}

void RegionModalityBase::MeasureOcclusions(
...
void RegionModalityBase::DoNotMeasureOcclusions() {
  depth_camera_ptr_ = nullptr;
  measure_occlusions_ = false;
  set_up_ = false;
}

void RegionModalityBase::ModelOcclusions(
...
void RegionModalityBase::set_visualize_points_depth_rendering_correspondence(
...
void RegionModalityBase::set_visualize_points_silhouette_rendering_correspondence(
...
void RegionModalityBase::set_visualize_points_optimization(
    bool visualize_points_optimization) {
  visualize_points_optimization_ = visualize_points_optimization;
  SetImshowVariables();
}

void RegionModalityBase::set_visualize_points_histogram_image_optimization(
...
void RegionModalityBase::set_visualize_points_result(bool visualize_points_result) {
  visualize_points_result_ = visualize_points_result;
  SetImshowVariables();
}

void RegionModalityBase::set_visualize_points_histogram_image_result(
...
void RegionModalityBase::set_visualization_min_depth(
    float visualization_min_depth) {
  visualization_min_depth_ = visualization_min_depth;
}

void RegionModalityBase::set_visualization_max_depth(
...
const std::shared_ptr<DepthCamera> &RegionModalityBase::depth_camera_ptr() const {
...
const std::shared_ptr<FocusedDepthRenderer>
    &RegionModalityBase::depth_renderer_ptr() const {
  return depth_renderer_ptr_;
}

const std::shared_ptr<FocusedSilhouetteRenderer>
    &RegionModalityBase::silhouette_renderer_ptr() const {
...
int RegionModalityBase::n_lines_max() const { return n_lines_max_; }

bool RegionModalityBase::use_adaptive_coverage() const {
  return use_adaptive_coverage_;
}

float RegionModalityBase::reference_contour_length() const {
  return reference_contour_length_;
}

float RegionModalityBase::min_continuous_distance() const {
  return min_continuous_distance_;
}

int RegionModalityBase::function_length() const { return function_length_; }

int RegionModalityBase::distribution_length() const { return distribution_length_; }

float RegionModalityBase::function_amplitude() const { return function_amplitude_; }

float RegionModalityBase::function_slope() const { return function_slope_; }

float RegionModalityBase::learning_rate() const { return learning_rate_; }

int RegionModalityBase::n_global_iterations() const { return n_global_iterations_; }

const std::vector<int> &RegionModalityBase::scales() const { return scales_; }

const std::vector<float> &RegionModalityBase::standard_deviations() const {
  return standard_deviations_;
}

bool RegionModalityBase::use_shared_color_histograms() const {
  return use_shared_color_histograms_;
}

int RegionModalityBase::n_histogram_bins() const {
  if (use_shared_color_histograms_) {
...
float RegionModalityBase::learning_rate_f() const {
  if (use_shared_color_histograms_) {
...
float RegionModalityBase::learning_rate_b() const {
  if (use_shared_color_histograms_) {
...
float RegionModalityBase::unconsidered_line_length() const {
  return unconsidered_line_length_;
}

float RegionModalityBase::max_considered_line_length() const {
  return max_considered_line_length_;
}

bool RegionModalityBase::use_region_checking() const {
  return use_region_checking_;
}

bool RegionModalityBase::measure_occlusions() const { return measure_occlusions_; }

float RegionModalityBase::measured_depth_offset_radius() const {
  return measured_depth_offset_radius_;
}

float RegionModalityBase::measured_occlusion_radius() const {
  return measured_occlusion_radius_;
}

float RegionModalityBase::measured_occlusion_threshold() const {
  return measured_occlusion_threshold_;
}

bool RegionModalityBase::model_occlusions() const { return model_occlusions_; }

float RegionModalityBase::modeled_depth_offset_radius() const {
  return modeled_depth_offset_radius_;
}

float RegionModalityBase::modeled_occlusion_radius() const {
  return modeled_occlusion_radius_;
}

float RegionModalityBase::modeled_occlusion_threshold() const {
  return modeled_occlusion_threshold_;
}

int RegionModalityBase::n_unoccluded_iterations() const {
  return n_unoccluded_iterations_;
}

int RegionModalityBase::min_n_unoccluded_lines() const {
  return min_n_unoccluded_lines_;
}

bool RegionModalityBase::visualize_lines_correspondence() const {
  return visualize_lines_correspondence_;
}

bool RegionModalityBase::visualize_points_correspondence() const {
  return visualize_points_correspondence_;
}

bool RegionModalityBase::visualize_points_depth_image_correspondence() const {
  return visualize_points_depth_image_correspondence_;
}

bool RegionModalityBase::visualize_points_depth_rendering_correspondence() const {
  return visualize_points_depth_rendering_correspondence_;
}

bool RegionModalityBase::visualize_points_silhouette_rendering_correspondence()
    const {
  return visualize_points_silhouette_rendering_correspondence_;
}

bool RegionModalityBase::visualize_points_optimization() const {
  return visualize_points_optimization_;
}

bool RegionModalityBase::visualize_points_histogram_image_optimization() const {
  return visualize_points_histogram_image_optimization_;
}

bool RegionModalityBase::visualize_points_result() const {
  return visualize_points_result_;
}

bool RegionModalityBase::visualize_points_histogram_image_result() const {
  return visualize_points_histogram_image_result_;
}

float RegionModalityBase::visualization_min_depth() const {
  return visualization_min_depth_;
}

float RegionModalityBase::visualization_max_depth() const {
  return visualization_max_depth_;
}

void RegionModalityBase::SetImshowVariables() {
...
bool RegionModalityBase::LoadMetaData() {
...
void RegionModalityBase::PrecalculateFunctionLookup() {
...
void RegionModalityBase::PrecalculateDistributionVariables() {
...
bool RegionModalityBase::SetUpInternalColorHistograms() {
...
void RegionModalityBase::PrecalculateCameraVariables() {
...
bool RegionModalityBase::PrecalculateModelVariables() {
...
void RegionModalityBase::PrecalculateRendererVariables() {
  if (model_occlusions_) {
...
void RegionModalityBase::PrecalculatePoseVariables() {
  body2camera_pose_ =
...
void RegionModalityBase::PrecalculateIterationDependentVariables(
    int corr_iteration) {
...
void RegionModalityBase::AddLinePixelColorsToTempHistograms(
    bool handle_occlusions) {
...
void RegionModalityBase::DynamicRegionDistance(
...
void RegionModalityBase::CalculateBasicLineData(
...
bool RegionModalityBase::IsLineValid(const DataLine &data_line,
...
bool RegionModalityBase::IsDynamicLineRegionSufficient(float center_u,
                                                   float center_v,
                                                   float normal_u,
...
bool RegionModalityBase::IsLineUnoccludedMeasured(
...
bool RegionModalityBase::IsLineUnoccludedModeled(float center_u, float center_v,
                                             float depth,
...
bool RegionModalityBase::CalculateSegmentProbabilities(
    float center_u, float center_v, float normal_u, float normal_v,
...
void RegionModalityBase::CalculateDistribution(
...
void RegionModalityBase::CalculateDistributionMoments(
...
void RegionModalityBase::ShowAndSaveImage(const std::string &title, int save_index,
...
void RegionModalityBase::VisualizePointsColorImage(const std::string &title,
...
void RegionModalityBase::VisualizePointsDepthImage(const std::string &title,
                                               int save_index) const {
  cv::Mat visualization_image;
...
void RegionModalityBase::VisualizePointsDepthRendering(const std::string &title,
                                                   int save_index) const {
  cv::Mat visualization_image;
...
void RegionModalityBase::VisualizePointsSilhouetteRendering(
...
void RegionModalityBase::VisualizePointsHistogramImage(const std::string &title,
                                                   int save_index) const {
...
void RegionModalityBase::VisualizeLines(const std::string &title,
                                    int save_index) const {
  cv::Mat visualization_image(color_camera_ptr_->image().size(), CV_8UC3);
  DrawProbabilityImage(cv::Vec3b{255, 255, 255}, &visualization_image);
...
void RegionModalityBase::DrawPoints(const cv::Vec3b &color_point,
                                cv::Mat *image) const {
...
void RegionModalityBase::DrawDepthPoints(const cv::Vec3b &color_point,
                                     cv::Mat *image) const {
  for (const auto &data_line : data_lines_) {
...
void RegionModalityBase::DrawFocusedPoints(
...
void RegionModalityBase::DrawLines(const cv::Vec3b &color_line,
...
void RegionModalityBase::DrawProbabilityImage(const cv::Vec3b &color_b,
...
float RegionModalityBase::MinAbsValueWithSignOfValue1(float value_1,
                                                  float abs_value_2) {
...
bool RegionModalityBase::IsSetup() const {
  if (!set_up_) {
